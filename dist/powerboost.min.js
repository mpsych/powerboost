...
class $c657645b9ba500f7$export$9cf5eb8cd6a286 {
    ...
    load_links() {
        ...
        (0, $be25f1620a50bfcc$export$f8f26dd395d7e1bd).load_Links("stylesheet", "https://github.com/RohiniDeshmukh/powerboost/blob/main/src/UI_components/style.css");
    }
    load_html(callback) {
        console.log("Loading HTML...");
        fetch("https://github.com/RohiniDeshmukh/powerboost/blob/main/src/UI_components/index.html").then((response)=>response.text()).then((htmlContent)=>{
    ...
    load_scripts(callback) {
        ...
        (0, $be25f1620a50bfcc$export$f8f26dd395d7e1bd).load_Scripts("https://rohinideshmukh.github.io/boostlet/dist/boostlet.min.js", "head");
        (0, $be25f1620a50bfcc$export$f8f26dd395d7e1bd).load_Scripts("https://cdnjs.cloudflare.com/ajax/libs/ace/1.33.0/ace.js", "head");
        (0, $be25f1620a50bfcc$export$f8f26dd395d7e1bd).load_Scripts("https://github.com/RohiniDeshmukh/powerboost/blob/main/src/UI_components/script.js", "body");
        // Simulate an asynchronous operation using setTimeout
        setTimeout(function() {
...
window.Powerboost.load_html(()=>{
    window.Powerboost.load_scripts(()=>{
