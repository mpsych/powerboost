...
class $c657645b9ba500f7$export$9cf5eb8cd6a286 {
    ...
    load_html(callback) {
        (0, $be25f1620a50bfcc$export$f8f26dd395d7e1bd).load_Html("https://mpsych.github.io/powerboost/src/UI_components/index.html");
    ...
    load_urls() {
        ...
        (0, $be25f1620a50bfcc$export$f8f26dd395d7e1bd).load_Links("stylesheet", "https://mpsych.github.io/powerboost/src/UI_components/style.css");
        ...
        (0, $be25f1620a50bfcc$export$f8f26dd395d7e1bd).load_Scripts("https://mpsych.github.io/boostlet/dist/boostlet.min.js");
    ...
    init() {
        ...
        this.toggleBtn.addEventListener("mouseup", (e)=>{
            ...
            if (!this.isMoving) {
                ...
                if (this.nav.classList.contains("open")) // show the rectbox
                this.toggleSpan(document.querySelector(".rect-box"));
                else // hide rectbox and all kids
...
class $ee836499a8d015e0$export$e1e795cef0e670e6 {
    ...
    createButton(text, className) {
        ...
        if (className == '') button.className = 'example-btn';
        else button.className = 'rect-btn ' + className;
        button.id = text;
...
setTimeout(async function() {
    ...
    const editor = new (0, $c6odg.Editor)(window.Powerboost.editor, "outputtext", "run-btn");
    editor.init();
    // Initialize the Categories class
    const categories = new (0, $ee836499a8d015e0$export$e1e795cef0e670e6)("nav");
