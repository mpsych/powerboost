...
class $be25f1620a50bfcc$export$f8f26dd395d7e1bd {
    ...
    static load_Html(url) {
        ...
        fetch(url).then((response)=>response.text()).then((htmlContent)=>{
            ...
            if (!main) document.body.appendChild(template.content.firstChild);
            else main.appendChild(template.content.firstChild);
...
class $5eee48fd03b591f2$export$4b85d3515bd863a5 {
    ...
    init() {
        ...
        document.querySelector(".fa-solid.fa-magnifying-glass").parentNode.addEventListener("click", ()=>this.appendScriptToHead(document.querySelector(".search-input").value));
    }
