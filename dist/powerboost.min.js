...
class $c657645b9ba500f7$export$9cf5eb8cd6a286 {
    ...
    load_html(callback) {
        ...
        fetch("https://rohinideshmukh.github.io/powerboost/src/UI_components/index.html").then((response)=>response.text()).then((htmlContent)=>{
    ...
    load_scripts(callback) {
        ...
        (0, $be25f1620a50bfcc$export$f8f26dd395d7e1bd).load_Scripts("https://rohinideshmukh.github.io/powerboost/src/UI_components/script.js", "body");
        // Simulate an asynchronous operation using setTimeout
        setTimeout(function() {
