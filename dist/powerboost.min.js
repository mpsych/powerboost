...
class $c657645b9ba500f7$export$9cf5eb8cd6a286 {
    ...
    load_html(callback) {
        ...
        (0, $be25f1620a50bfcc$export$f8f26dd395d7e1bd).load_Html("https://gaiborjosue.github.io/powerboost/src/UI_components/index.html");
    ...
    load_urls() {
        ...
        (0, $be25f1620a50bfcc$export$f8f26dd395d7e1bd).load_Links("stylesheet", "https://gaiborjosue.github.io/powerboost/src/UI_components/style.css");
        ...
        (0, $be25f1620a50bfcc$export$f8f26dd395d7e1bd).load_Scripts("https://gaiborjosuie.github.io/boostlet/dist/boostlet.min.js");
...
setTimeout(async function() {
    ...
    const editor = new (0, $c6odg.Editor)(window.Powerboost.editor, "output", "run-btn");
    editor.init();
    // Initialize the Categories class
    const categories = new (0, $ee836499a8d015e0$export$e1e795cef0e670e6)(Boostlet.categories, Boostlet.examples);
    await categories.init();
    // Initialize the search class
    const search = new (0, $5eee48fd03b591f2$export$4b85d3515bd863a5)();
    search.init();
}, 1000);
